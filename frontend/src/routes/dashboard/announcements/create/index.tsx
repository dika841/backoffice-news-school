...
import { useCreateAnnounMutation } from '@/hooks/mutation/use-announ-mutation/use-announ-mutation'
...
export const Route = createFileRoute('/dashboard/announcements/create/')({
...
function CreateAnnouncement() {
  ...
  const { mutate, isPending } = useCreateAnnounMutation()
      ...
      },
      {
        ...
        onError: (error) => {
          toast.error('Gagal ditambahkan', {
            position: 'top-right',
            richColors: true,
            description: error.message || 'Pengumuman gagal ditambahkan',
          })
        },
      },
    )
  ...
  return (
    <section className="space-y-8 py-8">
      <h1 className="text-4xl font-bold">Tulis Pengumuman</h1>
